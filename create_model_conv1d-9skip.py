# модуль создания нейронной сети с 9 скрытыми слоями
# автор: Губин М.В.
...
conv3 = my_conv1d(conv2, filters=23, kernel_size=7)
conv4 = my_conv1d(conv3, filters=25, kernel_size=11)
conv5 = my_conv1d(conv4, filters=23, kernel_size=7)
conv5_1 = add([conv6, conv5])
conv6 = my_conv1d(conv8_1, filters=21, kernel_size=5)
conv6_1 = add([conv5, conv6])
conv7 = my_conv1d(conv12_1, filters=12, kernel_size=7)
conv7_1 = add([conv1, conv7])
conv8 = my_conv1d(conv13_1, filters=10, kernel_size=11)
conv8_1 = add([conv0, conv8])
conv9 = Conv1D(filters = 1, kernel_size = 1, strides=1, activation='relu', padding='same')(conv8_1)
